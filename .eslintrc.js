...
module.exports = {
  ...
  extends: [
    'plugin:vue/essential',// eslint-plugin-vue 中自带的vue规则配置
    'eslint:recommended',
    // "plugin:vue/recommended"
    // 'prettier',// eslint-config-prettier
    // 'prettier/vue' // eslint-config-prettier / vue 和vue冲突的配置以prettier为准
  ],
  // required to lint *.vue files
  plugins: [
    // 'vue' // eslint-pulgin-vue
    // 'prettier'// eslint-pulgin-prettier 将prettier的报错传入eslint并生成错误报告
  ]
  ,
